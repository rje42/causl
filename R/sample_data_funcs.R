...
##' beta distributed or discrete respectively. `pars` should contain either
...
##'
##' @export
rescale_cop <- function(U, X, family = 1, pars, df, inverse = TRUE, cdf = FALSE) {
